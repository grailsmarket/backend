export const SEAPORT_ABI = [
  // Seaport 1.6 - fulfillBasicOrder_efficient_6GL6yc
  {
    "inputs": [
      {
        "components": [
  ...
  // Standard fulfillOrder function (kept for compatibility)
  {
    "inputs": [
      {
        "components": [
  ...
  // fulfillAdvancedOrder - supports conduit keys for fulfiller
  {
    "inputs": [
      {
        "components": [
